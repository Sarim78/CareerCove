      ...
      <main className="flex-1 px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12 max-w-7xl mx-auto w-full">
        ...
        {!user ? (
          <Card className="p-8 sm:p-12 text-center border-primary-100 mb-8">
            <Target className="w-16 h-16 mx-auto text-primary-300 mb-4" />
            <h3 className="text-lg sm:text-xl font-semibold text-primary-900 mb-2">Sign in to track your skills</h3>
            <p className="text-sm sm:text-base text-primary-600 mb-4">
              Create an account to start tracking your skills and monitor your progress
            </p>
            <Button
